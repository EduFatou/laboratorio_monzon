      ...
      <section className="home">
        <article>
          ...
          <div className="login-section">
            <h3>Bienvenid@, accede para enviar tu solicitud de presupuesto.</h3>
            <Login />
            <p>
              Laboratorio Monzón, donde transformamos sonrisas utilizando las últimas tecnologías y el conocimiento experto de nuestro equipo. Destacamos por ofrecer precios competitivos y resultados excelentes, garantizando la satisfacción de nuestros clientes.
            </p>
          </div>
          <div className='contact-section'>
          <p>Te atendemos en Sevilla, Calle Monzón, local bajo 6H.</p>
